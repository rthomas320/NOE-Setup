...
DIRTOMONITOR="/home/nifi/data/mockAnalyzer2/in"
DIRTOWRITE="/home/nifi/data/mockAnalyzer2/out"
JSONEXT=".json"
...
do
  ...
  do
    ...
    then
      ...
      echo "The report file '$FILEPART''$JSONEXT' was created." >> /home/nifi/data/mockAnalyzer2/analyzer2.log
